...
app.config['MAIL_USERNAME']='shivaprian@gmail.com'
app.config['MAIL_PASSWORD']='nuuh czwu hhku dzha'
...
def generate_qr_code(unique_identifier):
    ...
    url = f"http://127.0.0.1:5000/qr_redirect?id={unique_identifier}"
...
def send_mail(email, reason, unique_id):
    if email:
        ...
        """
        sender = "shivaprian@gmail.com"
        msg = Message(subject, sender=sender, recipients=['shivaprian552@gmail.com'])
        msg.html = body
        mail.send(msg)
